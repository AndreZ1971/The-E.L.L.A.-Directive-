...
_Generated: 2026-05-29T18:45:58.490Z_
...
Workspace `mcp.json` _(folder: ella-directive)_

- **z:\repos\ella-directive\.mcp.json** — _File missing_

_No active workspace servers in mcp.json._

## MCP — user profile

- **C:\Users\JannR\.claude.json** — _File exists — no servers defined_
